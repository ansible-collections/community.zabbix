...
- zabbix-agent - will no longer wipe tls_connect en tls_accept settings when not specified on update (https://github.com/ansible-collections/community.zabbix/pull/753)
