...
This role installs and configures the Zabbix Web Service, a component used for generating scheduled reports in Zabbix.
...
### Google Chrome
Google Chrome is required for the report generation.
Example sources:
* EL family/Suse: https://dl.google.com/linux/direct/google-chrome-stable_current_x86_64.rpm
